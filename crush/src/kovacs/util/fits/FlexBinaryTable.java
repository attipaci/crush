...
public class FlexBinaryTable {
	...
	public class Column {
		...
		public void addKeys(Cursor cursor) {
	...
	class ColumnCard {
		...
		public HeaderCard getHeaderCard(int index) {
			...
			return new HeaderCard(key + tail);
		}
		
		public void add(Cursor cursor, int index) {
