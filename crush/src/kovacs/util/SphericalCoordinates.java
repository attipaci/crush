...
public class SphericalCoordinates extends CoordinatePair implements Metric<SphericalCoordinates> {
	...
	public static Class<? extends SphericalCoordinates> getFITSClass(String spec) {
		...
		if(spec.startsWith("RA-")) return kovacs.util.astro.EquatorialCoordinates.class;
		else if(spec.startsWith("DEC-")) return kovacs.util.astro.EquatorialCoordinates.class;
		else if(spec.substring(1).startsWith("LON")) {
			switch(spec.charAt(0)) {
			case 'A' : return kovacs.util.astro.HorizontalCoordinates.class;
			case 'G' : return kovacs.util.astro.GalacticCoordinates.class;
			case 'E' : return kovacs.util.astro.EclipticCoordinates.class;
			case 'S' : return kovacs.util.astro.SuperGalacticCoordinates.class;
			}
		}
