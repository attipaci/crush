...
public abstract class GridImage<CoordinateType extends CoordinatePair> extends Data2D {
	...
	public double getUnderlyingFWHM() { return 0.0; }
	
	public double getImageFWHM() {
		return Math.hypot(getUnderlyingFWHM(), smoothFWHM);
	}
	
	public double getUnderlyingBeamArea() {
		final double A = fwhm2size * getUnderlyingFWHM();
		return A*A;		
	}
